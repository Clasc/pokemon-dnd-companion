  ...
  return (
    <div className="bg-white/10 rounded-lg p-3 text-white text-sm h-full flex flex-col justify-between">
      ...
      <button
        ...
        className="w-full mt-auto bg-interactive hover:bg-interactive-hover disabled:bg-gray-600/50 disabled:text-gray-400 disabled:cursor-not-allowed text-white font-bold py-1.5 px-2 rounded-md transition-colors text-xs"
      >
        Perform Attack
      </button>
    </div>
